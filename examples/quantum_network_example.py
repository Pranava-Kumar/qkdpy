...
def multiparty_qkd_example():
    ...
    # NOTE: In production, never print key material. This example uses
    # a pre-computed non-sensitive label for demonstration purposes only.
    secret = [1, 0, 1, 1, 0, 0, 1, 0, 1, 1, 0, 0, 1, 0, 1, 1]
    print("Original secret: [truncated — key material not logged]")
    ...
    for i, share in enumerate(shares):
        print(f"  Party {i + 1}: {len(share)} bits  # truncated")
