...
flowchart LR
    subgraph QKDPY_State["QKDpy State"]
        ...
        M1["MultiQubitState<br/>n-qubit vector"]
    end

    subgraph QISKIT_State["Qiskit State"]
        S2["QuantumCircuit<br/>+ StatevectorSimulator"]
        S3["Statevector object"]
    end

    subgraph PENNYLANE_State["PennyLane State"]
        S4["QNode + Device<br/>(default.qubit)"]
        S5["Circuit graph"]
    end

    subgraph CIRQ_State["Cirq State"]
        S6["Circuit<br/>+ Simulator"]
        S7["StateVectorMixin"]
    end
...
| Feature | Qiskit | PennyLane | Cirq | QpiAI |
|---------|--------|-----------|------|-------|
| E91 circuit | ✅ | ✅ | ✅ | ✅ |
| Bell test | ✅ | ✅ | ✅ | ✅ |
| Partial trace | ✅ | ❌ | ✅ | ❌ |
